...
class IMS:
    def __init__(self,root):
        ...
        btn_category=Button(LeftMenu,text="Category",command=self.catagory,image=self.icon_side,compound=LEFT,padx=5,anchor="w",font=("times new roman",20,"bold"),bg="white",bd=3,cursor="hand2").pack(side=TOP,fill=X)
        ...
        #footer
        lbl_footer=Label(self.root,text="IMS- Inventory Management System",font=("rimes new roman",15),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
