...
class Login_System:
    def __init__(self,root):
        ...
        or_=Label(login_frame,text="OR",bg="white",fg="lightgray",font=("times new roman",15,"bold")).place(x=150,y=357)

        btn_forget=Button(login_frame,text="Forget Password?",command=self.forget_window,font=("times new roman",13),bg="white",fg="#00759E",bd=0,activebackground="white",activeforeground="#00759E").place(x=110,y=390)
        ...
        self.lbl_change_image.place(x=367,y=133,width=240,height=428)

        self.animate()
        
        ########All Functions_______
        ...
        try:
            ...
            if self.employee_id.get()=="":
                ...
                if email==None:
                    ...
                    lbl_reset=Label(self.forget_win,text='Enter OTP to Registered email',font=("times new roman",15)).place(x=20,y=60)
