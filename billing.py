...
class BillClass:
    def __init__(self,root):
        ...
        title=Label(self.root,text="Inventory Management System",image=self.icon_title,compound=LEFT,font=("rimes new roman",40,"bold"),bg="#010c49",fg="white",anchor="w",padx=20).place(x=0,y=1,relwidth=1,height=70)

        #logout
        btn_logout=Button(self.root,text="Logout",command=self.logout,font=("times new roman",15,"bold"),bg="magenta",cursor="hand2").place(x=1100,y=10,height=50,width=150)

        #clock
        self.lbl_clock=Label(self.root,text="Inventory\t\t Date: DD-MM-YYYY\t\t Time: HH:MM:SS",font=("rimes new roman",15),bg="#4d636d",fg="white")
        ...
        lbl_search=Label(Product_Frame2,text="Product Name",font=("time new roman",15,"bold"),bg="white").place(x=2,y=45)
        txt_search=Entry(Product_Frame2,textvariable=self.var_search,font=("time new roman",15),bg="lightyellow").place(x=140,y=47,width=150,height=22)
        ...
        lbl_contact=Label(CustomerFrame,text="Contact No.",font=("time new roman",15),bg="white").place(x=270,y=35)
        ...
        txt_p_price=Entry(Add_CartWidgetsFrame,textvariable=self.var_price,font=("times new roman",15),bg="lightyellow",state="readonly").place(x=200,y=35,width=180,height=22)
        ...
        self.lbl_net_pay=Label(billMenuFrame,text='Net Play\n[0]',font=("goudy old style",15,"bold"),bg="#607d8b",fg="white")
        ...
        ##Footer
        footer=Label(self.root,text="IMS Inventory Mnanagement System",font=("times new roman",11),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
    ...
    def bill_top(self):
        ...
        bill_top_temp=f'''
\t\tXYZ-Inventory
\t Phone No.63704323378,Bhubaneswar-751012
{str("="*47)}
...
{str("="*47)}\n
    ...
    def update_date_time(self):
        ...
        self.lbl_clock.config(text=f"Inventory\t\t Date: {str(date_)}\t\t Time: {str(time_)}")
